...
/**
 * Implementation of a fieldcentric mecanum drivebase.  This Drivebase will 
...
public class FieldcentricMecanumDrivebase implements IDrivebase{
	...
	@Override public void drive() {
		//TODO transfer FieldCentric from local algorithms to dev code
	}

	@Override public void update() {
		/*
		 * unimplemented.  See RobotcentricMecanumDrivebase.update() for details.
		 */
	}
