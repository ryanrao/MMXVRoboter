...
/**
 * Interface with default behaviors defined for a tray dependent on the
 * Robot and Sensors code of this particular setup.  This class is provided
 * for convenience to avoid locking the ITray interface to the Robot class
...
public interface RobotTray extends ITray{
	...
	/**
	 * A default implementation for extend.  Some tray states might override
	 * this with a no-op.
