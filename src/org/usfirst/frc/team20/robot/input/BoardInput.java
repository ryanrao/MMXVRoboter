...
public class BoardInput implements Runnable, OperatorInput{
	...
	public BoardInput(String hostname, int port) throws UnknownHostException, IOException{
	...
	@Override public void run() {
		for(;;){
			...
			try {
				...
				Logger.getGlobal().log(Level.SEVERE, "Error on read from board.");
			}
		}
	}
